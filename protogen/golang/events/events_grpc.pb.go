...
const (
	EventsService_Get_FullMethodName = "/events.EventsService/Get"
)
...
func (c *eventsServiceClient) Get(ctx context.Context, in *GetEventsRequest, opts ...grpc.CallOption) (*GetEventsResponse, error) {
...
func (UnimplementedEventsServiceServer) Get(context.Context, *GetEventsRequest) (*GetEventsResponse, error) {
...
func _EventsService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServiceServer).Get(ctx, req.(*GetEventsRequest))
	}
