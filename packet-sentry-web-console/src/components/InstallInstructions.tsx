...
export function InstallInstructions({ os }: InstallInstructionsProps) {
    return (
        <>
              ...
              <p>You've downloaded the installer for {os}.
                Use the instructions below to run it on the device.
                When prompted, enter the install key.</p>
              {os === 'Windows x64' ? (
                <p>{INSTALLER_INSTRUCTIONS[os]}</p>
              ) : (
